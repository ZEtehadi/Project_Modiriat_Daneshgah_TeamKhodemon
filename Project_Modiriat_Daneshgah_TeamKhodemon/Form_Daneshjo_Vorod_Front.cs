...
{
    public partial class Form_Daneshjo_Vorod_Front : Form
    {
        ...
        Form_Daneshjo_Pardakht_Front F_Pardakht = new Form_Daneshjo_Pardakht_Front();
        Form_Daneshjo_Karname F_Karname = new Form_Daneshjo_Karname();

        int Shahriye = 0;
        public Form_Daneshjo_Vorod_Front()
        {
            InitializeComponent();
        }

        private void Form_Daneshjo_Vorod_Front_Load(object sender, EventArgs e)
        {
            this.Top = 120;
            this.Left = 200;
