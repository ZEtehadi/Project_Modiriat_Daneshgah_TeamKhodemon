...
{
    public partial class Form_Daneshjo_Pardakht_Pardakht_Front : Form
    {
        public SqlConnection Con;

        int minute = 1;
        int second = 0;
        public Form_Daneshjo_Pardakht_Pardakht_Front()
        {
            InitializeComponent();
        }

        private void Form_Daneshjo_Pardakht_Pardakht_Front_Load(object sender, EventArgs e)
        {
            this.Left = 207;
            this.Top = 126;
